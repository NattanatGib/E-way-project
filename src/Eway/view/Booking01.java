 ...
 * @author hp
 */
public class Booking01 extends JFrame implements ActionListener {
    ...
    //เมื่อกดปุ่ม01.00ในหน้าเลือกเวลา จะแสดงหน้ากรอกข้อมูลขึ้นมา
    public Booking01() {
        panelBooking();
    }
    ...
    public void panelBooking() {
        ...
        //text 23.00
        JLabel txt_23 = new JLabel();
        txt_23.setText("01.00");
        txt_23.setFont(new java.awt.Font("4815_KwangMD_Catthai", 1, 26));
        txt_23.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txt_23);
        txt_23.setBounds(250, 90, 150, 30);
        booking.add(txt_23);
        ...
        btn_booking.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                String time = date;
                time += " 01:00:00";
                Booking b = new Booking(time, date, pickUp.getText(), 111);
