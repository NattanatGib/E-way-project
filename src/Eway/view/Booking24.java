 ...
 * @author hp
 */
public class Booking24 extends JFrame implements ActionListener {
    ...
    //เมื่อกดปุ่ม24.00ในหน้าเลือกเวลา จะแสดงหน้ากรอกข้อมูลขึ้นมา
    public Booking24() {
        panelBooking();
    }
    ...
    public void panelBooking() {
        ...
        btn_booking.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                String time = date;
                time += " 24:00:00";
                Booking b = new Booking(time, date, pickUp.getText(), 11);
