...
public class BookingHomeGUI extends JFrame implements ActionListener {
    ...
    public void panelBooking() {
        ...
        timeEtc.addActionListener(new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new BookingEtc().setVisible(true);
            }
        });
        booking.add(timeEtc);
    ...
    public static void main(String[] args) {
        BookingHomeGUI bus = new BookingHomeGUI();
        bus.panelBooking();
        bus.setVisible(true);
    }
}
