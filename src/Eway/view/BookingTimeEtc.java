 ...
 * @author hp
 */
public class BookingTimeEtc extends javax.swing.JFrame {

    /**
     * Creates new form BookingTimeEtc
     */
    public BookingTimeEtc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txt_time.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 16)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookingTimeEtc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
